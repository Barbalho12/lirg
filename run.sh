...
# g++ -std=c++11 -pthread -Wall src/render.cpp -o render && ./render samples/blinn_phong_base/img_9.txt


## PRECISA AJEITAR
# g++ -std=c++11 -pthread -Wall src/render.cpp -o render && ./render samples/cartoons/img_0.txt
# g++ -std=c++11 -pthread -Wall src/render.cpp -o render && ./render samples/cartoons/img_2.txt
# g++ -std=c++11 -pthread -Wall src/render.cpp -o render && ./render samples/cartoons/img_3.txt
# g++ -std=c++11 -pthread -Wall src/render.cpp -o render && ./render samples/cartoons/img_5.txt
...
# g++ -std=c++11 -pthread -Wall src/render.cpp -o render && ./render samples/blinn_phong_base/img_10.txt
# g++ -std=c++11 -pthread -Wall src/render.cpp -o render && ./render samples/blinn_phong_base/img_11.txt
# g++ -std=c++11 -pthread -Wall src/render.cpp -o render && ./render samples/blinn_phong_base/img_12.txt
# g++ -std=c++11 -pthread -Wall src/render.cpp -o render && ./render samples/blinn_phong_base/img_13.txt
# g++ -std=c++11 -pthread -Wall src/render.cpp -o render && ./render samples/blinn_phong_base/img_14.txt
